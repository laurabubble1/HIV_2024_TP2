...
class HTMLParserPowerSchedule(AbstractPowerSchedule):
    """HTML parser power schedule implementation. Assign more energy to seeds that execute faster and yield coverage increases more often."""
